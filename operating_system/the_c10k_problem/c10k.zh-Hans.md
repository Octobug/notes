...
一句，某些操作系统收取的 $100/客户的许可费看起来有些沉重！）综上看来，硬件已经不再是瓶颈了。
...
Unix 操作系统为中心，它们是我个人比较感兴趣的操作系统，当然也涵盖了一些和 Windows 有关的内
容。
...
Nick Black 这篇出色的文章 [Fast UNIX Servers](http://dank.qemfd.net/dankwiki/index.php/Network_server)
(译者注: 链接已失效) 能让你了解到 2009 年前后该问题的情况。

2003 年十月，Felix von Leitner 发布了网络可扩展性相关的 [文章](http://bulk.fefe.de/scalability/)
及 [报告](http://bulk.fefe.de/scalable-networking.pdf)，它们囊括了比较不同网络系统调用
