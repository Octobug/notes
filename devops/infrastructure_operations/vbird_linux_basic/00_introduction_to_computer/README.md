...
- [第零章、计算机概论](#第零章计算机概论)
  - [目录](#目录)
  - [1. 计算机：辅助人脑的好工具](#1-计算机辅助人脑的好工具)
    - [1.1 計算机硬件的五大单元](#11-計算机硬件的五大单元)
    - [1.2 CPU的种类](#12-cpu的种类)
    - [1.3 周边设备](#13-周边设备)
    - [1.4 运作流程](#14-运作流程)
    - [1.5 計算机分类](#15-計算机分类)
    - [1.6 計算机上面常用的计算单位 (容量、速度等)](#16-計算机上面常用的计算单位-容量速度等)
  - [2. 个人计算机架构与周边设备](#2-个人计算机架构与周边设备)
    - [2.1 CPU：CPU的外频与倍频, 32位与64位, CPU等级](#21-cpucpu的外频与倍频-32位与64位-cpu等级)
    - [2.2 內存](#22-內存)
    - [2.3 显卡](#23-显卡)
    - [2.4 硬盘与储存设备](#24-硬盘与储存设备)
    - [2.5 PCI 接口](#25-pci-接口)
    - [2.6 主机板](#26-主机板)
    - [2.7 电源供应器](#27-电源供应器)
    - [2.8 选购须知](#28-选购须知)
  - [3. 数据表示方式](#3-数据表示方式)
    - [3.1 数字系统](#31-数字系统)
    - [3.2 文字编码系统](#32-文字编码系统)
  - [4. 软件程序运作](#4-软件程序运作)
    - [4.1 机器程序与编译程序](#41-机器程序与编译程序)
    - [4.2 操作系统](#42-操作系统)
    - [4.3 应用程序](#43-应用程序)
  - [5. 重点回顾](#5-重点回顾)
  - [6. 本章习题](#6-本章习题)
