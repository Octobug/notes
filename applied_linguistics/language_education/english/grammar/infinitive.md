...
- 这个句子相当于 The thing that you should try to be these days is a gold-collar.
...
除了用 for 引导不定式的逻辑主语外，在某些特殊情况下要用 of 引导逻辑主语。
这种特殊情况就是使用了这样一类特殊的形容词：
用来说明人的性格特征或行为表现的形容词，当它们与不定式连用时，要用
“of + 名词或代词”这一结构引出不定式的逻辑主语。这样的形容词主要有：

- brave
- careful, careless, clever, cruel
- foolish
- generous
- kind
- modest
...
- polite
- rude
- selfish, silly, stupid
- thoughtful
- wise

`1` It's wise of you not to agree with your boss.
...
这种结构的用法比较有限，仅限于作主语的不定式，不能像“for + 名词或代词 + to do”这个结构用来作各种成分，比如状语、主语、定语或表语等。

值得注意的是，用 of 的句子，可以用“人”作主语将句子改写，而用 for 的句子则不能。

`4`

- You are wise not to argue with your boss.
  - wise 是强调人的性格特征或行为表现的，所以可以用“人”作主语；
- You are important to go there in person.
  - important 是强调事情的，不是强调人，不能用“人”直接作它的主语。

### 思维训练：9. 不定式的逻辑主语

**选择最佳答案填空。**

*2. ____ a really strong bond, the surfaces to be glued must be absolutely clean
and free from moisture or grease.*

- *A. Any adhesive to make*
- *B. To make any adhesive*
- *C. For any adhesive to make*
- *D. Making nay adhesive*

#### 答案：9. 不定式的逻辑主语

*2. C。不定式的逻辑主语与句子主语不一致，此时必须通过 for 来引出不定式的逻辑主语。

## 10. 不定式的时态和语态（一）：被动式 (to be done)

### 10.1 不定式时态语态简介

不定式作为一种动词的变化形式，具有动词的一般特征，即有时态和语态的变化。
英文中把动作的完成程度分为四种，即有四种不同的体态 (aspect)：
...
同理，不定式也具有这四种体态，而且不定式同样还有语态方面的变化。因此，不定式的时态和语态的构成如下：

| 体态       | 主动                 | 被动                 |
| ---------- | -------------------- | -------------------- |
| 一般式     | to write             | to be written        |
| 完成式     | to have written      | to have been written |
| 进行式     | to be writting       | 一般不用             |
| 完成进行式 | to have been writing | 一般不用             |

从以上表格可以看到，不定式主要有六种不同的结构形式。

### 10.2 被动不定式

一般来讲，在句中若出现了不定式动作的执行者，则不定式用主动形式；若没有执行者，或不定式所修饰的成本是不定式动作的承受者，则不定式用被动形式。

`1`

- He wants someone to take some photographs.
  - someone 充当 take 的执行者，所以不定式用主动形式。
- He wants some photographs to be taken.
  - he 不是 take 的执行者，而且也没有其他执行者，所以不定式要用被动形式。
- `译` 他想找人拍几张照片。

`2`

- I have three letters to type today.
  - I 是 type 的执行者。
  - `译` 我今天要打印三封信。
- I want the letters to be typed at once.
  - I 不是 type 的执行者。
  - `译` 我想找人立即把这些信打印出来。
...
- `译` 经常有人提醒我们注意自己的缺点是必要的。

#### 二、作宾语的被动不定式

`6` She doesn't like to be treated as a distinguised guest.
...
- `译` Johnson 先生宁愿被分配作繁重些的工作。

`10` It is known that electrical and chemical energy began to be studied
systematically in the last century.

- `译` 众所周知，电能和化学能是在上个世纪开始被系统研究的。
...
💡 to let (出租) 和 to blame (责备) 这两个短语是固定用法，主动形式表示被动意思。

`16` You should be to blame for it.

- `译` 你该为此受责备。
- You should be to be blamed for it. ❌
...
双重被动，就是指句子的谓语是被动的，谓语后面接的不定式也是被动的，从而形成两个被动结构连用的现象。

单一被动句有两种情况，一是句子的谓语用主动，不定式用被动。
...
### 思维训练：10. 不定式的时态和语态（一）：被动式 (to be done)

**一、用括号中动词的适当形式填空。**

*10. The reason is not far to ____ (seek).*

*11. The magazine is interesting to ____ (read).*

*15. They found the lecture hard to ____ (understand).*

#### 答案：思维训练：10. 不定式的时态和语态（一）：被动式 (to be done)

*10. seek。这里用主动形式表示被动意思。

*11. read。这里用主动形式表示被动意思。
