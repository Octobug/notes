...
`22` A: Do you know where John is now?
...
- 这里的 may 并不是针对现在实际情况的结果来推测其发生的原因，而是表示一般理论上的可能。
- `译` 学生主要是从书本和课堂上获得知识。
...
因此，从“将来能够”和“今天能够”变成“昨天能够”，改变的不仅是时态问题，更重要的是其中 can
所包含的“潜在可能性”这一核心思维。
...
直接把否定词 not 置于情态动词后面即构成其否定结构，但是在意义理解上有差别。
根据含义不同，可以把情态动词的否定区分为“内部否定”和“外部否定”。

### 17.1 情态动词否定意义的深层结构——内部否定和外部否定

`1` A: The restaurant is always empty.

B1: It can't be good.

B2: It may not be good.

这里 can't 和 may not 所表达的确定程度不同，can't 表示 90% 确定，是很有把握的陈述；
而 may not 表示 50% 确定，是不太有把握的陈述，所以翻译时有“不可能”和“可能不”的区别。

将否定词 not 分别放在情态动词前和后，其含义会有差异（尽管在形式上，not 总是放在情态动词后）。
为了区分这种含义上的差异：

- 外部否定 (external negation)：not + 情态动词 + 谓语动词 (NOT MODAL VERB)
- 内部否定 (internal negation)：情态动词 + not + 谓语动词 (MODAL NOT VERB)

以上例子中，“cannot + 谓语动词”属于外部否定，意思是“不可能”；
而“may + not + 谓语动词”属于内部否定，意思是“可能不”。

由于在形式上 not 都是在情态动词后，所以对于某些句子来说，就会产生深层结构上的歧义：

`2` Paul won't come.

- 理解为外部否定：Paul NOT will come.
  - 这里被否定的是 will，即 NOT will。
  - `译` Paul 不愿意来。
- 理解为内部否定：Paul will not come.
  - 这里被否定的是 come，即 NOT come.
  - `译` Paul 不会来。
...
- Paul won't come because he doesn't want to.
  - `译` Paul 不愿意来，因为他就是不想来。
- Paul won't come because he's too busy.
  - `译` Paul 不会来，因为他太忙。

和陈述句不同，在疑问句中深层结构直接体现在形式上，即 not 的位置会有不同：

`4`

- Could you not come?
  - 由于采用了内部否定，在变成疑问句时，只能把情态动词 could 提前，而否定词 not 留在原来的位置。
  - `译` 你能不来吗？（不希望你来）
- Couldn't you come?
  - 由于采用了外部否定，在变成疑问句时，要把情态动词和 not 一并提前到句首。
  - `译` 你不能来吗？（非常希望你能来）
...
这两种不同的否定结构，常常用在表示“请求”或“要求”的句型中，如以上疑问句都是表示“请求”的意思。
这种用法有如下规律：

- 如果否定词 not 没有与情态动词的缩写形式一起被提至句首，而是直接置于谓语动词之前，这时被否定的就是谓语动词，即“某事不应该做”；
- 而当否定词与情态动词的缩写形式放在一起时，被否定的就是情态动词，用来加强“请求”的含义，强调“某事应该做”。

`6`

- Will you please not get into the room?
  - `译` 你能不进这个房间里吗？
- Won't you please get into the room?
  - `译` 你难道就不能进这个房间里吗？
...
- How couldn't you tell me?
  - `译` 你怎么就不能告诉我呢？（对方一直不肯告诉自己）

`11` Who could not fall in love with Nate?
...
这两种否定结构与情态动词的两种基本意义有关：推测用法和基本用法。一般具有这样的规律：
...
- Paul won't come because he doesn't want to.
  - won't 表示“不愿意”，will 表示“愿意”，属于 will 的基本含义和用法，即这里否定的是情态意义。
  - `译` Paul 不愿意来，因为他就是不想来。
- Paul won't come because he's too busy.
  - won't 表示“将不来”，will 表示“预测”，属于 will 的推测用法，这里否定的是谓语动作 come。
  - `译` Paul 不会来，因为他太忙。

`2`

- You can leave now, but he may not leave.
  - may 表示许可，是基本用法，所以 may not 是否定情态意义。
  - `译` 你现在可以走了，但他不可以走。
- Tom will come, but John may not come.
  - may 表示可能，是推测用法，所以 may not 是否定谓语动词 come。
  - `译` Tom 会来，但约翰可能不来了。

`3` It won't rain.

- will 表示推测，所以 won't 否定的是谓语动作。
- `译` 天不会下雨。

`4` It shouldn't last long.

- should 表示推测，所以 shouldn't 否定的是谓语动作。
- `译` 应该不会太久的。

`5` He won't help us.

- will 表示“意愿”，属于基本用法，won't 是否定情态意义。
- `译` 他不愿意帮我们。

`6` You can't smoke here.

- can 表示“许可”，属于基本用法，won't 是否定情态意义。
- `译` 你不能在这里抽烟。

`7` You can't be serious.

- can 表示推测，属于推测用法。但这里 can't 是外部否定“不可恶”，而不是内部否定“可能不”。
  此时 can 不适用于前面说的两条规律。
- `译` 你不可能是当真的吧。

同样地，对于 must，上述规则也不适用。因为 must 用于推测用法时，本身没有否定，mustn't 并不表示推测。
当 must 用于基本含义表示“必须”时，其否定形式 mustn't 的意思是“千万别做某事”，这里否定的是谓语动作，即一个哪部否定。
must 的外部否定“不必”应说成 don't have to。

还有其他特殊的否定句：

`8` I can't believe you don't want to know. I mean, I couldn't not know, I mean,
if, if the doctor knows, and Carol knows, and Susan knows...
