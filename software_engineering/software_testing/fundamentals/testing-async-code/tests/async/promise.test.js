...
describe('AsyncTest', function () {
  it('should return `You get a sweet :)` if `true` is passed in',
    function () {
  ...
  it('should return `You get nothing!!` if `false` is passed in',
    function () {
      return expect(someMadeUpAyncFunc(false)).to.eventually.equal(
        'You get nothing!!'
      );
    });
});
