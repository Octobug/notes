...
roles 中有两个地方可以定义变量，vars/main.yml 和 defaults/main.yml，前者优先级比在 play 中定义的变量高，这意味这 play 变量无法覆盖 vars/main.yml。defaults/main.yml 变量优先级比 play 变量低，当 roles 中的变量有改变的需要时，应该写在 defaults/main.yml 中
